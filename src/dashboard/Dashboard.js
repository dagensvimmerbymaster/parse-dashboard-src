...
export default class Dashboard extends React.Component {
  ...
  render() {
    ...
    // Anpassade Push-routes & redirect för specialanpassad /schedule/push/new
    const PushRoutes = (
      <>
        ...
        <Route path="schedule/push/new" element={<PushScheduleNew />} />
        {/* Om du vill ha redirect exakt så som gamla versionen */}
        <Route path="schedule/push" element={<Navigate replace to="schedule/push/new" />} />
      </>
    );
